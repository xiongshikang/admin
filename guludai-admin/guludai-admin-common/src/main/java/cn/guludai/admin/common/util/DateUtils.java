...
public class DateUtils {
	...
	public static final String DEFAULT_DATE_TOGETHER_FORMATTER = "yyyyMMddHHmmssSSS";
...
//		return null;
	 ...
	 * @return
	 */
	public static String getCurrentTogetherTime(){
		SimpleDateFormat f = new SimpleDateFormat(DEFAULT_DATE_TOGETHER_FORMATTER);
		Date d = new Date();
		return f.format(d);
	}
	...
	public static void main(String[] args) {
		System.out.println(getCurrentTogetherTime());
	}
}
